                ...
                {(['7-Page Calendar', '13-Page Calendar'] as Promotion[]).map((promo) => (
                  <button
                    ...
                    className={`flex-1 py-4 px-4 rounded-xl font-semibold text-sm transition-all duration-200 border ${
                      promotion === promo
                        ? 'border-red-500 bg-white text-red-700 shadow-lg shadow-red-100 transform scale-[1.02]'
              ...
              <div className="animate-in fade-in slide-in-from-top-4 duration-300">
                ...
                {unitPrice !== null && (
                  <div className="mt-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <p className="text-2xl font-bold text-gray-900">R {formatPrice(unitPrice)}</p>
                  </div>
                )}
              </div>
            )}
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        ...
                        <p className="text-sm font-semibold text-gray-900">{productOption}</p>
                      </div>
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        <p className="text-xs text-gray-500 mb-1">Colour</p>
                        <p className="text-sm font-semibold text-gray-900">Full Colour</p>
                      </div>
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex justify-between items-baseline py-2 border-b border-gray-100">
                      ...
                      <span className="text-base font-semibold text-gray-900">{getQuantity().toLocaleString('en-ZA')} units</span>
                    </div>
                    <div className="flex justify-between items-baseline py-2 border-b border-gray-100">
                      <span className="text-sm text-gray-600">Unit Price</span>
                      <span className="text-base font-semibold text-gray-900">R {formatPrice(unitPrice)}</span>
                    </div>
                  </div>
